...
def parse_opt(known=False):
    ...
    parser.add_argument('--epochs', type=int, default=10, help='total training epochs')#11
    parser.add_argument('--batch-size', type=int, default=4, help='total batch size for all GPUs, -1 for autobatch')#11
    ...
    parser.add_argument('--device', default='0', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')#11
